...
| P1-F2 | Real pg_dump & restore verification against production + 7-day retention default + R2 credential gap documentation | P1-F | company-ops/company_ops/backup.py, company-ops/.env.example, company-ops/NAHAR-TODO.md, company-ops/PLAN.md, tests/test_backup.py | antigravity | claimed | Live pg_dump against production + restore into scratch instance to verify data integrity; change retention default 30 -> 7; document R2 credential gap in NAHAR-TODO.md |
