...
This is a development environment: quality and maintainability outrank
backwards compatibility with the current manager/MCP wiring. Refactor that
wiring when a clean A2A boundary is the better design.
